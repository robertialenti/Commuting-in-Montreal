...
You can view interactive maps showing modal shares for [car, truck, or vans](https://github.com/robertialenti/Commuting-in-Montreal/raw/main/figures/Active_transportation_map.html) using the appropriate link.
