...
You can view interactive maps showing modal shares for [car, truck, or vans](https://robertialenti.github.io/Commuting-in-Montreal/figures/Active_transportation_map.html) using the appropriate link.
